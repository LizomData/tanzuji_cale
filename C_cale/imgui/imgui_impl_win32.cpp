...
static void ImGui_ImplWin32_CreateWindow(ImGuiViewport* viewport)
{
    ...
    //LONG exStyle = GetWindowLong(vd->Hwnd, GWL_EXSTYLE);
    //exStyle |= WS_EX_TOOLWINDOW | WS_EX_LAYERED;
    //SetWindowLong(vd->Hwnd, GWL_EXSTYLE, exStyle);
    //SetLayeredWindowAttributes(vd->Hwnd, 0, 1.0f, LWA_ALPHA);
    //SetLayeredWindowAttributes(vd->Hwnd, 0, ImColor(255,255,255), LWA_COLORKEY);
