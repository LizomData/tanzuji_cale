...
namespace ImGui
{
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v,ImU32 TextColor=0);
    ...
    IMGUI_API bool          InputTextMultiline(int sty,const char* label, char* buf, size_t buf_size, const ImVec2& size = ImVec2(0, 0), ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
